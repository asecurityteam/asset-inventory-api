...
// Source: github.com/asecurityteam/asset-inventory-api/pkg/domain (interfaces: PartitionGenerator,PartitionsGetter,PartitionsDeleter,CloudAssetStorer,CloudAssetByIPFetcher,CloudAssetByHostnameFetcher,CloudAssetByARNIDFetcher,CloudAllAssetsByTimeFetcher,SchemaMigratorUp,SchemaMigratorDown,SchemaVersionGetter,BackFillSchemaRunner,SchemaVersionForcer,AccountOwnerStorer)
...
// MockCloudAssetByARNIDFetcher is a mock of CloudAssetByARNIDFetcher interface
type MockCloudAssetByARNIDFetcher struct {
	ctrl     *gomock.Controller
	recorder *MockCloudAssetByARNIDFetcherMockRecorder
}

// MockCloudAssetByARNIDFetcherMockRecorder is the mock recorder for MockCloudAssetByARNIDFetcher
type MockCloudAssetByARNIDFetcherMockRecorder struct {
	mock *MockCloudAssetByARNIDFetcher
}

// NewMockCloudAssetByARNIDFetcher creates a new mock instance
func NewMockCloudAssetByARNIDFetcher(ctrl *gomock.Controller) *MockCloudAssetByARNIDFetcher {
	mock := &MockCloudAssetByARNIDFetcher{ctrl: ctrl}
	mock.recorder = &MockCloudAssetByARNIDFetcherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockCloudAssetByARNIDFetcher) EXPECT() *MockCloudAssetByARNIDFetcherMockRecorder {
	return m.recorder
}

// FetchByARNID mocks base method
func (m *MockCloudAssetByARNIDFetcher) FetchByARNID(arg0 context.Context, arg1 time.Time, arg2 string) ([]domain.CloudAssetDetails, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchByARNID", arg0, arg1, arg2)
	ret0, _ := ret[0].([]domain.CloudAssetDetails)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FetchByARNID indicates an expected call of FetchByARNID
func (mr *MockCloudAssetByARNIDFetcherMockRecorder) FetchByARNID(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchByARNID", reflect.TypeOf((*MockCloudAssetByARNIDFetcher)(nil).FetchByARNID), arg0, arg1, arg2)
}
